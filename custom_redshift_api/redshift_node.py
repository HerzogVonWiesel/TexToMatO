...
from . import redshift_ID as rsID # Commonly Used IDs for Redshift
#=============================================
#                   ID
#=============================================
...
# =====  Connections  ===== #  
    ...
    # todo 获取当前port连接线 
    # 添加连接线 ==> OK 
    def AddConnection(self, soure_node, outPort, target_node, inPort, removeExisting=True):
        """
    ...
    def AddtoOutput(self, soure_node, outPort):
        ...
        """
        endNode = self.GetRSOutput()        
        return self.AddConnection(soure_node, outPort, endNode, rsID.PortStr.Output_Surface) is not None
    # 连接到Output置换接口
    def AddtoDisplacement(self, soure_node, outPort):
        ...
        return self.AddConnection(soure_node, outPort, rsoutput, rsID.PortStr.Output_Displacement) is not None
...
# =====  Material itself  ===== #
    ...
    def SetMaterialName(self, name):
        ...
        Returns the name of the material.
        """
        return self.material.SetName(name)
